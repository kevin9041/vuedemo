...
var vm = new Vue({
    ...
    //在 webpack 中，如果仅仅通过把组件放在components中,页面不会展示
    // components: {
    //   login
    // },
    //  render: function (createElements) { // 在 webpack 中，如果想要通过 vue把一个组件放到页面中去展示，vm 实例中的 render 函数可以实现
...
import defaultVar, { title as title_rename, content } from './exportTest.js'
console.log("defaultVar_age:"+defaultVar.age)
console.log("defaultVar_age:"+defaultVar.age)
console.log(title_rename + ' --- ' + content)
